...
// Returns true if x is divisible by 2, false otherwise.
func IsEven(x int) bool {
	return x%2 == 0
}

// IsOdd checks if an integer x is odd.
// Returns true if x is not divisible by 2, false otherwise.
...
// For x = 0 or x = 1, it returns 1. Otherwise, it returns x!.
...
// using the formula: LCM(x, y) = (x / GCD(x, y)) * y.
